    ...
    <div class="container mx-auto">
        ...
        <div class="bg-white p-6 rounded shadow-md mt-6">
            <form action="{{ route('bands.store') }}" method="POST">
                ...
                <div class="mb-4">
                    <label for="genre" class="block text-gray-700">Band Genre:</label>
                ...
                <div class="mb-4">
                    <label for="founded" class="block text-gray-700">Band Founded:</label>
                ...
                <div class="mb-4">
                    <label for="active_till" class="block text-gray-700">Band Active Till:</label>
